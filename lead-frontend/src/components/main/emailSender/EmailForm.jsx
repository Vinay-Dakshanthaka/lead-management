...
const EmailForm = ({ onSubmit, isSending }) => {
    ...
    const handleSubmit = (e) => {
        ...
        data.append("text", formData.text); // Send formatted text to backend
        ...
        // Attach other files (attachments)
        ...
        <form onSubmit={handleSubmit} className="mb-4">
            ...
            <div className="mb-3">
                ...
                <input
                    ...
                    disabled={!!formData.excelFile} // Disable if Excel is uploaded
                />
            ...
            <div className="mb-3">
                ...
                <input
                    ...
                    disabled={!!formData.to} // Disable if 'To' field is filled out
                />
            ...
            {/* Email Body with ReactQuill Editor */}
            <div className="mb-3">
